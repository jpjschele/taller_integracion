...
ActiveRecord::Schema.define(version: 20180513015644) do
  ...
  create_table "product_readies", force: :cascade do |t|
    t.string "productoId"
    t.bigint "order_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["order_id"], name: "index_product_readies_on_order_id"
  end
  ...
  add_foreign_key "product_readies", "orders"
end
